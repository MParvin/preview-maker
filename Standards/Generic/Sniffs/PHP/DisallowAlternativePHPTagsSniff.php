...
class DisallowAlternativePHPTagsSniff implements Sniff
{
     ...
     * @param integer $length  The target length of the snippet to get. Defaults to 40.
     *
     * @return string
     */
     ...
     * @param \PHP_CodeSniffer\Files\File $phpcsFile       The file being scanned.
     * @param array                       $tokens          The token stack.
     * @param integer                     $openTagPointer  Stack pointer to the PHP open tag.
     * @param integer                     $closeTagPointer Stack pointer to the PHP close tag.
     * @param boolean                     $echo            Whether to add 'echo' or not.
     *
     * @return void
     */
